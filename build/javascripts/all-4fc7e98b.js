    ...
    return {
      shoot: function(params) {
        ...
        if(params.route && params.error){
          $http({
            method: 'POST',
            url: '//dapi.votolegal.com.br/api/troubleshoot',
...
$(document).ready(function(){
  ...
  $.getJSON("//dapi.votolegal.com.br/api/stats", function(res){
...
app.votolegal.controller('CadastroController', ['$scope', '$http', '$location', '$route', '$interval', 'auth_service', 'serialize', 'SweetAlert', 'trouble', function($scope, $http, $location, $route, $interval, auth_service, serialize, SweetAlert, trouble){
  ...
  $scope.save_project = function(index){
    ...
    $http({
      ...
      url: '//dapi.votolegal.com.br/api/candidate/'+ user.id +'/projects' + (p.id && p.id > 0 ? '/' + p.id : '') +"?api_key=" + user.api_key,
      data: serialize.from_object(params),
      headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
    }).then(function (response) {
  ...
  $scope.get_projects = function(){
    ...
    $http.get(
      '//dapi.votolegal.com.br/api/candidate/' + user.id + '/projects', { api_key: user.api_key }
    ).then( function(response){
  ...
  $scope.get_gateways = function(){
    $http({
      method: 'GET',
      url: '//dapi.votolegal.com.br/api/payment_gateway',
    }).then(function(response){
...
app.votolegal.controller('CandidateController', ["$scope", "$http", "$sce", "serialize", "auth_service", "SweetAlert", "trouble", "postmon", function($scope, $http, $sce, serialize, auth_service, SweetAlert, trouble, postmon){
  ...
  $scope.candidate_by_name = function(name){
    $http({
      method: 'GET',
      url: '//dapi.votolegal.com.br/api/candidate/'+ name,
    }).
    then(
      function(response){
		var res = response.data.candidate;
  ...
  $scope.candidate_projects = function(candidate){
    $http({
      method: 'GET',
      url: '//dapi.votolegal.com.br/api/candidate/'+ candidate.id +'/projects',
    }).
    then(
      function(response){
  ...
  $scope.candidate_expenditures = function(candidate){
    ...
    try {
      $http({method: 'GET', url: '//dapi.votolegal.com.br/api/candidate/'+ candidate.id +'/expenditure?results=99999'}).
      then(
        function(response){
          var res = response.data;
  ...
  $scope.candidate_donations = function(candidate){
    ...
    try {
      $http({method: 'GET', url: '//dapi.votolegal.com.br/api/candidate/'+ candidate.id +'/donate?results=9999'}).
      then(
        function(response){
