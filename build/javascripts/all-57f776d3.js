...
// base uri
var BASE_API = '//api-to.votolegal.com.br/api';
    ...
    return {
      shoot: function(params) {
        ...
        if(params.route && params.error){
          $http({
            method: 'POST', 
            url: '//api-to.votolegal.com.br/api/troubleshoot', 
  ...
  app.votolegal.factory('auth_service', ['$http', 'serialize', 'store', function($http, serialize, store){
    return {
      ...
      authenticate: function(username, password) {
        return $http({
          method: 'POST',
          url: '//api-to.votolegal.com.br/api/login',
      ...
      forgot_password: function(username){
        return $http({
          method: 'POST',
          url: '//api-to.votolegal.com.br/api/login/forgot_password',
      ...
      change_password: function(password, token){
        return $http({
          method: 'POST',
          url: '//api-to.votolegal.com.br/api/login/forgot_password/reset/' + token,
...
app.votolegal.controller('PreCadastroController', ['$scope', '$http', 'postmon', 'serialize', function($scope, $http, postmon, serialize){
  ...
  $scope.create = function(isValid){
    ...
    $http({
      method: 'POST', 
      url: '//api-to.votolegal.com.br/api/register', 
      data: serialize.from_object(params),
      headers: {'Content-Type': 'application/x-www-form-urlencoded'}
    })
    .then(
  ...
  $scope.load_parties = function(){
    $http.get('//api-to.votolegal.com.br/api/party')
    .then(
  ...
  $scope.load_offices = function(){
    $http.get('//api-to.votolegal.com.br/api/office')
    .then(
...
app.votolegal.controller('ContatoController', ['$scope', '$http', 'serialize', function($scope, $http, serialize){
  ...
  $scope.create = function(isValid){
    ...
    $http({
      method: 'POST', 
      url: '//api-to.votolegal.com.br/api/contact', 
      data: serialize.from_object(params),
      headers : {'Content-Type': 'application/x-www-form-urlencoded'}
    })
    .then(
...
app.votolegal.controller('DashboardController', ["$scope", "$http", "auth_service", "serialize", "SweetAlert", function($scope, $http, auth_service, serialize, SweetAlert){
  ...
  $scope.approval_list = function(){
    ...
    $http.get('//api-to.votolegal.com.br/api/admin/candidate/list?results=9999&api_key=' + user.api_key)
    .then(
      function(response){
        var res = response.data;
        $scope.list = res;
  ...
  $scope.allow = function(model){
    ...
    function(isConfirm){
      if (isConfirm) {
        $http({
          method: 'PUT',
          url: '//api-to.votolegal.com.br/api/admin/candidate/'+ model.id +'/activate?api_key='+ user.api_key,
        }).
        then(
          // success callback
          function(response){
  ...
  $scope.deny = function(model){
    ...
    function(isConfirm){
      if (isConfirm) {
        $http({
          method: 'PUT',
          url: '//api-to.votolegal.com.br/api/admin/candidate/'+ model.id +'/deactivate?api_key='+ user.api_key,
        }).
        then(
          // success callback
          function(response){
...
app.votolegal.controller('CadastroController', ['$scope', '$http', '$location', '$route', '$interval', 'auth_service', 'serialize', 'SweetAlert', 'trouble', function($scope, $http, $location, $route, $interval, auth_service, serialize, SweetAlert, trouble){
  ...
  $scope.save_candidate = function(index){
    ...
    try {
      $http({
        method: 'PUT',
        url: '//api-to.votolegal.com.br/api/candidate/'+ user.id +"?api_key=" + user.api_key,
        data: params,
  ...
  $scope.save_project = function(index){
    ...
    $http({
      ...
      url: '//api-to.votolegal.com.br/api/candidate/'+ user.id +'/projects' + (p.id && p.id > 0 ? '/' + p.id : '') +"?api_key=" + user.api_key,
      data: serialize.from_object(params),
      headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
    }).then(function (response) {
    ...
    function(isConfirm){
      if (isConfirm) {
        if(item.hasOwnProperty('id') && item.id > 0){
          var user = auth_service.current_user();
          $http.delete(
            '//api-to.votolegal.com.br/api/candidate/' + user.id + '/projects/' + item.id + '?api_key='+ user.api_key
          ).then(function(response){
  ...
  $scope.get_projects = function(){
    ...
    $http.get(
      '//api-to.votolegal.com.br/api/candidate/' + user.id + '/projects', { api_key: user.api_key }
    ).then( function(response){
  ...
  $scope.get_issues_priority = function(){
    $http.get('//api-to.votolegal.com.br/api/issue_priority').
    then(
      function(response){
  ...
  $scope.get_banks = function(){
    $http({
      method: 'GET',
      url: '//api-to.votolegal.com.br/api/bank',
    }).
    then(function(response){
  ...
  $scope.get_gateways = function(){
    $http({
      method: 'GET',
      url: '//api-to.votolegal.com.br/api/payment_gateway',
    }).then(function(response){
...
app.votolegal.controller('ExploreController', ["$scope", "$http", "auth_service", "serialize", "SweetAlert", "trouble", function($scope, $http, auth_service, serialize, SweetAlert, trouble){
  ...
  $scope.load_list = function(term){
    ...
    $http({
      method: 'post',
      url: '//api-to.votolegal.com.br/api/search?results=9999',
      data: serialize.from_object(params),
      headers: {'Content-Type': 'application/x-www-form-urlencoded'}
    })
    .then(
...
app.votolegal.controller('CandidateController', ["$scope", "$http", "$sce", "serialize", "auth_service", "SweetAlert", "trouble", "postmon", function($scope, $http, $sce, serialize, auth_service, SweetAlert, trouble, postmon){
  ...
  $scope.candidate_by_name = function(name){
    $http({
      method: 'GET',
      url: '//api-to.votolegal.com.br/api/candidate/'+ name,
    }).
    then(
      function(response){
        var res = response.data.candidate;
  ...
  $scope.candidate_projects = function(candidate){
    $http({
      method: 'GET',
      url: '//api-to.votolegal.com.br/api/candidate/'+ candidate.id +'/projects',
    }).
    then(
      function(response){
  ...
  $scope.candidate_expenditures = function(candidate){
    ...
    try {
      $http({method: 'GET', url: '//api-to.votolegal.com.br/api/candidate/'+ candidate.id +'/expenditure?results=99999'}).
      then(
        function(response){
          var res = response.data;
  ...
  $scope.candidate_donations = function(candidate){
    ...
    try {
      $http({method: 'GET', url: '//api-to.votolegal.com.br/api/candidate/'+ candidate.id +'/donate?results=9999'}).
      then(
        function(response){
  ...
  $scope.get_session = function(){
    ...
    $http({
      url: '//api-to.votolegal.com.br/api/candidate/'+id+'/donate/session'
    }).
    then(function(response){
  ...
  $scope.send_donation = function(){
    ...
    if($scope.candidate.payment_gateway_id === 1){
      ...
      $http({
        method: 'POST',
        url : '//api-to.votolegal.com.br/api/candidate/'+ $scope.candidate.id +'/donate',
        data: serialize.from_object(params),
        headers: {'Content-Type': 'application/x-www-form-urlencoded'}
      }).then(function(response){
...
app.votolegal.controller('VoteController', ["$scope", "$http", "$sce", "serialize", "$interval", "SweetAlert", "trouble", "postmon", function($scope, $http, $sce, serialize, $interval, SweetAlert, trouble, postmon){
  ...
  $scope.save_vote = function(){
    ...
    if(list && list.length === 3){
      ...
      $http({
        method: 'POST',
        url: '//api-to.votolegal.com.br/api/',
        data: serialize.from_object(params),
        headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
      }).then(function(response){
...
app.votolegal.controller('BoletoController', ['$scope', '$http', 'postmon', 'auth_service', 'serialize', 'SweetAlert', 'trouble', function($scope, $http, postmon, auth_service, serialize, SweetAlert, trouble){
  ...
  $scope.get_session = function(){
    ...
    $http({
      method: 'GET',
      url: '//api-to.votolegal.com.br/api/candidate/'+user.id+'/payment/session?api_key=' + user.api_key,
    }).
    then(function(response){
  ...
  $scope.generate = function(){
    ...
    $http({
      ...
      $http({
        method: 'POST',
        url: '//api-to.votolegal.com.br/api/candidate/'+user.id+'/payment?api_key='+user.api_key,
...
app.votolegal.controller('DonationHistoryController', ["$scope", "$http", "$sce", "serialize", "auth_service", "SweetAlert", "trouble", "postmon", function($scope, $http, $sce, serialize, auth_service, SweetAlert, trouble, postmon){
  ...
  $scope.history_list = function(user){
    ...
    try {
      $http({
        method: 'GET', 
        url: '//api-to.votolegal.com.br/api/candidate/'+ user.id +'/donate?results=9999&api_key=' + user.api_key 
      }).
      then(
        function(response){
          var res = response.data.donations;
  ...
  $scope.download.csv_file = function(){
    var user = $scope.user;
    console.log('//api-to.votolegal.com.br/api/candidate/'+ user.id +'/donate/download/csv?api_key=' + user.api_key);
    return '//api-to.votolegal.com.br/api/candidate/'+ user.id +'/donate/download/csv?api_key=' + user.api_key;
  };
...
$(document).ready(function(){
  ...
  $.getJSON("//api-to.votolegal.com.br/api/stats", function(res){
    ...
    $('#total_amount_raised').html((function(){
      ...
      return formater.format({simbol: false});
    }()));
